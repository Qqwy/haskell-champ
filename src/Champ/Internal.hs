...
; {-# INLINE singletonMap #-}                                                                                                                         \
; singletonMap !h !k v = ManyMap_/**/name 1 (unsafeCoerce $ h) (unsafeCoerce k) (unsafeCoerce (solo @(valstorage) v)) mempty                          \
; {-# INLINE manyMap #-}                                                                                                                              \
...
; ManyMap_/**/name 1 (unsafeCoerce -> h) (unsafeCoerce -> k) (unsafeCoerce -> soloV) _ -> (#  | (# h, k, unSolo @(valstorage) soloV #) | #)           \

...
import Data.HashMap.Lazy qualified as HashMapLazy
import Data.HashMap.Strict qualified as HashMapStrict
import GHC.IsList
...
insertSmallBench =
  Bench.bgroup "insert (small)" $
    mconcat
      [ [ Bench.bench ("HashMapLazy." <> show n) $ Bench.nf (HashMapLazy.insert n n) (buildN n),
          Bench.bench ("HashMapStrict." <> show n) $ Bench.nf (HashMapStrict.insert n n) (buildN n),
...
lookupSmallBench =
  Bench.bgroup "Lookup (small)" $
    mconcat
      [ [ Bench.bench ("HashMapLazy." <> show n) $ Bench.nf (HashMapLazy.lookup (n)) (buildN n),
          Bench.bench ("HashMapStrict." <> show n) $ Bench.nf (HashMapStrict.lookup (n)) (buildN n),
...
foldrSmallBench =
  Bench.bgroup "Foldr (+) 0 (small)" $
    mconcat
          [ [ Bench.bench ("HashMapLazy." <> show n) $ Bench.nf (HashMapLazy.foldr (+) 0) (buildN @HashMap n),
              Bench.bench ("HashMapStrict." <> show n) $ Bench.nf (HashMapStrict.foldr (+) 0) (buildN @HashMap n),
...
foldl'SmallBench =
  Bench.bgroup "foldl' (+) 0 (small)" $
    mconcat
          [ [ Bench.bench ("HashMapLazy." <> show n) $ Bench.nf (HashMapLazy.foldl' (+) 0) (buildN @HashMap n),
              Bench.bench ("HashMapStrict." <> show n) $ Bench.nf (HashMapStrict.foldl' (+) 0) (buildN @HashMap n),
...
toListSmallBench =
  Bench.bgroup "toList (small)" $
     mconcat
          [ [ Bench.bench ("HashMapLazy." <> show n) $ Bench.nf (HashMapLazy.toList) (buildN @HashMap n),
              Bench.bench ("HashMapStrict." <> show n) $ Bench.nf (HashMapStrict.toList) (buildN @HashMap n),
...
-- theirinsert = HashMapLazy.insert
...
-- theirlookup = HashMapLazy.lookup
